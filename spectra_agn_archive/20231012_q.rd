    ...
    <make table="raw_data">
      <rowmaker idmaps="*">
        ...
        <apply procDef="//ssap#fill-plainlocation">
          <bind key="ra">@RA_DEG </bind><!--The spectra center ra -->
          <bind key="dec">@DEC_DEG</bind><!--The spectra center dec -->
          <bind key="aperture">0.0028</bind><!--The split's width in degrees -->
