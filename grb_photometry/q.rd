<resource schema="grb_photometry" resdir=".">
  ...
  <service id="web" allowed="form" core="imagecore">
    <meta name="shortName">grb_photometry web</meta>
    ...
    <outputTable autoCols="accref,accsize,centerAlpha,centerDelta,
    	...
    	<outputField original="pub_did" tablehead="Datalink">
				<formatter>
					return T.a(href="/grb_photometry/q/dl/dlmeta?ID="
  ...
  <regSuite title="grb_photometry regression">
    ...
    <regTest title="grb_photometry SIAP serves some data">
      <url POS="251.5,72.3" SIZE="0.1,0.1" dateObs="59107.7/" 
        >i/siap.xml</url>
      <code>
    ...
    <regTest title="grb_photometry datalink looks plausible">
      <url
        ID="ivo://fai.kz/~?grb_photometry/data/GRB200829A-0005_r.fit"
        >dl/dlmeta</url>
      <code>
        rows = self.getVOTableRows()
        ...
        self.assertTrue(bySemantics["#this"]["access_url"].endswith(
          "getproduct/grb_photometry/data/GRB200829A-0005_r.fit"),
          "#this URI is wrong")
        self.assertEqual(bySemantics["#this"]["content_length"], 4680000)
      </code>
    </regTest>
  </regSuite>
</resource>
